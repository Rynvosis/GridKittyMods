...
**Ascension check:** An empire counts as ascended once it has adopted any ascension-path tradition tree (cybernetics, cybernetics-assimilator, genetics, cloning, mutation, psionics, psionics-shroud, synthetics, nanotech, modularity, virtuality, purity). Since vanilla's adopt nodes gate on (AP) OR (early-access origin with prereq tech), this naturally excludes civic-only empires (`civic_chosen`, `civic_corporate_chosen`, `civic_augmentation_bazaars`) — they need the AP before they can unlock the tree — while including empires whose origin grants them ascension access without an AP (Teachers of the Shroud, Cybernetic Creed, Hard Reset / Unplugged, Synthetic Fertility, Endbringers, post-liberation Shroud Forged).
